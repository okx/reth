...
impl crate::Compact for OpTxType {
        ...
        B: bytes::BufMut + AsMut<[u8]>,
    {
        ...
        match self {
            ...
            Self::PostExec => unimplemented!("OpTxType::PostExec compact encoding not supported"),
        }
    }
...
impl Compact for OpTypedTransaction {
        ...
        B: bytes::BufMut + AsMut<[u8]>,
    {
        ...
        match self {
            ...
            Self::PostExec(_) => {
                unimplemented!("OpTypedTransaction::PostExec compact encoding not supported")
            }
        };
        identifier
    }
    ...
    fn from_compact(buf: &[u8], identifier: usize) -> (Self, &[u8]) {
        ...
        match tx_type {
            ...
            OpTxType::PostExec => {
                unimplemented!("OpTxType::PostExec compact decoding not supported")
            }
        }
    }
}
...
impl ToTxCompact for OpTxEnvelope {
    fn to_tx_compact(&self, buf: &mut (impl BufMut + AsMut<[u8]>)) {
        match self {
            ...
            Self::PostExec(_) => unimplemented!("OpTxEnvelope::PostExec compact encoding not supported"),
        };
    }
}
