...
impl<T, H> TrieWitness<T, H> {
    ...
    /// No-op for compatibility with upstream API; execution witness mode is currently
    /// not differentiated in the local witness implementation.
    pub fn with_execution_witness_mode(
        self,
