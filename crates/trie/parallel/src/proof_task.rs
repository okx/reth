    ...
    Provider: TrieCursorFactory + HashedCursorFactory,
{
    ...
    fn compute_v2_storage_proof(
        ...
        if targets.is_empty() {
            targets.push(reth_trie_common::ProofV2Target::new(B256::ZERO));
        }
...
pub(crate) enum StorageProofResult {
    ...
    V2 {
        ...
        proof: Vec<reth_trie_common::ProofTrieNodeV2>,
...
impl From<StorageProofResult> for Option<DecodedStorageMultiProof> {
    ...
    fn from(proof_result: StorageProofResult) -> Self {
        match proof_result {
            ...
            // V2 path uses TrieNodeV2 internally; conversion to legacy DecodedStorageMultiProof
            // (which uses TrieNode) is not implemented yet — fall back to None.
            StorageProofResult::V2 { .. } => None,
        }
    }
}
...
pub enum StorageProofInput {
    ...
    V2 {
        ...
        targets: Vec<reth_trie_common::ProofV2Target>,
    },
}
...
impl StorageProofInput {
    ...
    pub const fn new(hashed_address: B256, targets: Vec<reth_trie_common::ProofV2Target>) -> Self {
