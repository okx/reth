...
use reth_primitives_traits::{Block, BlockTy, HeaderTy, header::HeaderMut, NodePrimitives, ReceiptTy, Recovered, RecoveredBlock};
        ...
        > + Unpin,
{
        ...
        N::BlockHeader: HeaderMut,
    {
        ...
        Ok(Some(
            ExecutedBlock::new(
                Arc::new(RecoveredBlock::new_unhashed(
