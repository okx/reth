...
impl EVMStateStore {
    ...
    fn apply_grouped(
        ...
        let errors: Vec<SeiDbError> = std::thread::scope(|s| {
...
impl StateStore for EVMStateStore {
    ...
    fn iterator(
        ...
        Err(SeiDbError::Other("evm state store: cross-type iteration not supported".into()))
    }
    ...
    fn reverse_iterator(
        ...
        Err(SeiDbError::Other("evm state store: cross-type reverse iteration not supported".into()))
    }
    ...
    fn raw_iterate(
        ...
        Err(SeiDbError::Other("evm state store: RawIterate not supported".into()))
    }
    ...
    fn close(&mut self) -> Result<()> {
        let mut last_err: Option<SeiDbError> = None;
