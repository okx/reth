...
mod tests {
    ...
    use seidb_traits::{iterator::DbIterator, types::SnapshotNode};
    ...
    impl StateStore for MockStateStore {
        ...
        fn apply_changeset_sync(&self, _: i64, _: &[seidb_proto::NamedChangeSet]) -> Result<()> {
            Ok(())
        }

        fn apply_changeset_async(&self, _: i64, _: &[seidb_proto::NamedChangeSet]) -> Result<()> {
            Ok(())
        }
